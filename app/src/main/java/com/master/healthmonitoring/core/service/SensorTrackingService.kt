package com.master.healthmonitoring.core.service
...
import com.master.healthmonitoring.feature.heartrate.domain.use_case.HeartRateUseCases
...
class SensorTrackingService : Service() {
    ...
    companion object {
        const val ACTION_START_SERVICE = "com.master.healthmonitoring.START_SENSOR_TRACKING"
        const val ACTION_STOP_SERVICE = "com.master.healthmonitoring.STOP_SENSOR_TRACKING"
